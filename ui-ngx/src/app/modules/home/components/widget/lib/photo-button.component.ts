...
import { WidgetButtonAppearance } from '@app/shared/components/button/widget-button.models';
...
// @dynamic
@Component({
  selector: 'tb-photo-button-widget',
  templateUrl: './photo-button.component.html',
  styleUrls: ['./photo-button.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class PhotoButtonWidgetComponent extends PageComponent implements OnInit, OnDestroy {
  disabled = false;
  activated = false;
